...
![Twin Marks AI New Feature](https://i.imgur.com/Rb78oEf.png)
...
*   **ナビゲーション機能**: 検索結果を順次巡回できるナビゲーションボタン（`<` `>`）を搭載。
...
*   **SF風UIデザイン**: 
    *   検索結果のノードは**シアン色**に発光し、強力なオーラを纏います。
    *   マウスオーバー時にはノードが拡大し、**SFモニタ風**の詳細情報パネルが表示されます。
